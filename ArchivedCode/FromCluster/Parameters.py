...
Dist = 50 									# Distance that the control paramter travels
sigma = 1 									# Variance of control parameter velocity fluctuations

TimeSeparation = 1 							#Fractional difference between the relaxation time of the system and the control parameter dynamics t_sys/t_lambda
