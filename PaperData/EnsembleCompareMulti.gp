...
#set label 11 "Stochastic Ensemble" at screen 0.17,0.945 font "Times-Roman, 11"
#set label 12 "(Underdamped)" at screen 0.18,0.925 font "Times-Roman, 11"

#set object circle at screen 0.35,0.935 size scr 0.01 fc rgb "blue" fs transparent solid 0.5 noborder
#set label 13 "Constant Velocity Ensemble" at screen 0.37,0.935 font "Times-Roman, 11"

#set arrow from screen 0.6,0.92 to screen 0.725,0.92 nohead lw 3 lc rgb "black"
#set label 14 "Theoretical Prediction" at screen 0.595,0.94 font "Times-Roman, 11"
...
set label 11 "Theoretical Prediction" at screen 0.675, 0.19 font "Times-Roman,12"
set label 12 "Lower Bound" at screen 0.675, 0.14 font "Times-Roman,12"
...
set label 13 "Stochastic Ensemble" at screen 0.421,0.18 font "Times-Roman,12"
set label 14 "Constant Velocity Ensemble" at screen 0.421, 0.13 font "Times-Roman,12"

set multiplot layout 3,3 rowsfirst

@TLMARGIN
@YTICS; @NOXTICS
plot "StochasticProtocol2/WorkTotal_L20_k4_a99.dat" with circles lc rgb "red" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/SimulationData/WorkTotal_L20_k4_1.dat" with circles lc rgb "blue" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/WorkTheory/WorkTotalExact_20_k4_Var_1.dat" with line lt "dashed" lw 1.5 lc rgb "blue" ,\
	 "StochasticTheory/WorkTotalTheory_20_k4_Var_1.dat" with line lt 1 lw 1.5 lc rgb "black"

@TMMARGIN
@NOYTICS; @NOXTICS
plot "StochasticProtocol2/WorkTotal_L20_k16_a99.dat" with circles lc rgb "red" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/SimulationData/WorkTotal_L20_k16_1.dat" with circles lc rgb "blue" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/WorkTheory/WorkTotalExact_20_k16_Var_1.dat" with line lt "dashed" lw 1.5 lc rgb "blue" ,\
...
@MLMARGIN
@YTICS; @NOXTICS
plot "StochasticProtocol2/WorkTotal_L40_k4_a99.dat" with circles lc rgb "red" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/SimulationData/WorkTotal_L40_k4_1.dat" with circles lc rgb "blue" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/WorkTheory/WorkTotalExact_40_k4_Var_1.dat" with line lt "dashed" lw 1.5 lc rgb "blue" ,\
	 "StochasticTheory/WorkTotalTheory_40_k4_Var_1.dat" with line lt 1 lw 1.5 lc rgb "black" 

@MMMARGIN
@NOYTICS; @NOXTICS
plot "StochasticProtocol2/WorkTotal_L40_k16_a99.dat" with circles lc rgb "red" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/SimulationData/WorkTotal_L40_k16_1.dat" with circles lc rgb "blue" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/WorkTheory/WorkTotalExact_40_k16_Var_1.dat" with line lt "dashed" lw 1.5 lc rgb "blue" ,\
...
@BLMARGIN
@YTICS; @XTICS
plot "StochasticProtocol2/WorkTotal_L80_k4_a99.dat" with circles lc rgb "red" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/SimulationData/WorkTotal_L80_k4_1.dat" with circles lc rgb "blue" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/WorkTheory/WorkTotalExact_80_k4_Var_1.dat" with line lt "dashed" lw 1.5 lc rgb "blue" ,\
	 "StochasticTheory/WorkTotalTheory_80_k4_Var_1.dat" with line lt 1 lw 1.5 lc rgb "black" 

@BMMARGIN
@NOYTICS; @XTICS
plot "StochasticProtocol2/WorkTotal_L80_k16_a99.dat" with circles lc rgb "red" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/SimulationData/WorkTotal_L80_k16_1.dat" with circles lc rgb "blue" fs transparent solid 0.5 noborder, \
	 "ConstantVelocity/WorkTheory/WorkTotalExact_80_k16_Var_1.dat" with line lt "dashed" lw 1.5 lc rgb "blue" ,\
