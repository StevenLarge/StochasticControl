...
def Primary(PositionTrack,TimeSeparation,WriteName):
...
def RelaxationTime(AutoCorrelation):

	RelaxationTime = []

	for index in range(len(AutoCorrelation)):

		RelaxationTime.append(AutoCorrelation[index]/AutoCorrelation[0])
