...
Times = ['TimeSeparation2_256/','TimeSeparation2_512/','TimeSeparation2_1024/','TimeSeparation2_2048/','TimeSeparation2_4096/','TimeSeparation2_8192/']

NumberTimes = [256, 512, 1024, 2048, 4096, 8192]
